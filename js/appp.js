(() => {
    ...
    const langArr = {
        ...
        "ad-item-text-1": {
            ru: "детально о товаре",
            en: "more details",
            ua: "и гарантуємо, що завдяки нашому висококваліфікованому персоналу та гнучкій політиці продажу, ми зможемо налагодити оптимальний режим фінансування, що відповідатиме Вашим потребам та забезпечить оптимальний грошовий потік "
        },
        "ad-item-text-2": {
            ru: "детально о товаре",
