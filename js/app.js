(() => {
    ...
    var arrLang = {
        en: {
            ...
            contacts: "Contacts",
            title: "IBO-KOM",
            "title-sub": "Our competence - polymers",
            "title-sub-2": "Success - is our common goal!",
            "about-title": "About Us",
            "about-text": "Over the years of its activity, the IVO-COM company managed to gather considerable experience and recognition in the market of plastic raw materials. Thanks to strategic partnerships with world leaders in the production of plastics, we provide high quality and a wide range of products to our customers. Our company is constantly working to meet the needs of our polymer buyers in the shortest possible time. Also, the company is successfully expanding its boundaries and attracting new partners in many industries. The company was founded in 1997, and since then it has made a significant contribution to the development of the Ukrainian polymer market.",
            "about-button": "Contact Us",
            "ad-title": "Advantages",
            "ad-title-2": "More than 20 years on market",
            "ad-title-3": "Performance analysis",
            "ad-title-4": "Individual logistic support",
            "ad-text-1": "The company has direct contracts with major global manufacturers in the USA, Europe and Saudi Arabia, China , Korea.",
            "ad-text-2": "We guarantee that thanks to our highly qualified staff and flexible sales policy, we will be able to establish the optimal financing regime that will meet your needs and ensure optimal cash flow.",
            "ad-text-3": "We provide a wide range of services for the delivery of goods, including delivery to the port, warehouse or directly to your production with the help of our logistics fleet and cooperation with partners.",
            "prod-title": "Our products",
            "prod-title-2": "Polypropylene",
            "prod-title-3": "Polyethylene",
            "prod-text-1": "Homopolymer",
            "prod-text-2": "Copolymer",
            "prod-text-3": "Random Polymer",
            "part-title": "Partners",
            "cont-title": "Contacts",
            "cont-text-1": "Office:",
            "cont-text-2": "Sales department:",
            "cont-text-3": "Storage:",
            "cont-text-4": "Email",
        ...
        uk: {
            ...
            contacts: "Контакти",
            title: "IBO-KOM",
            "title-sub": "Наша Компетенція - полімери,",
            "title-sub-2": "Успіх- наша спільна ціль!",
            "about-title": "Про компанію",
            "about-text": "За роки своєї діяльності, компанія IVO-COM зуміла зібрати значний досвід та визнання на ринку пластикової сировини. Завдяки стратегічному партнерству зі світовими лідерами у виробництві пластиків, ми забезпечуємо високу якість та широкий асортимент продукції нашим клієнтам. Наша компанія постійно працює над тим, щоб задовольнити потреби наших покупців полімерів у найкоротші терміни.Також, компанія успішно розширює свої межі та залучає нових партнерів у багатьох галузях промисловості. Компанія була заснована в 1997 році, і з тих пір вона зробила вагомий внесок у розвиток ринку полімерів України",
            "about-button": "Зв'язатись",
            "ad-title": "Переваги",
            "ad-title-2": "Більше 20 років на ринку",
            "ad-title-3": "Аналіз ефективності",
            "ad-title-4": "Індивідуальна логістична підтримка",
            "ad-text-1": "Компанія має прямі контракти з великими світовими виробниками в США, Європі та Саудівській Аравії, Китаї, Кореї.",
            "ad-text-2": "Ми гарантуємо, що завдяки нашому висококваліфікованому персоналу та гнучкій політиці продажу, ми зможемо налагодити оптимальний режим фінансування, що відповідатиме Вашим потребам та забезпечить оптимальний грошовий потік.",
            "ad-text-3": "Ми забезпечуємо широкий спектр послуг з доставки товарів, включаючи доставку до порту, складу або прямо на Ваше виробництво за допомогою нашого логістичного флоту та співпраці з партнерами.",
            "prod-title": "Продукція",
            "prod-title-2": "ПОЛІПРОПІЛЕН",
            "prod-title-3": "ПОЛІЕТИЛЕН",
            "prod-text-1": "Гомополімер",
            "prod-text-2": "Сополімер",
            "prod-text-3": "Рандомполімер",
            "part-title": "Наші Партнери",
            "cont-title": "Контакти",
            "cont-text-1": "Офіс:",
            "cont-text-2": "Відділ продажу:",
            "cont-text-3": "Склад:",
            "cont-phone": "Телефон: ",
            "cont-email": "Пошта: ",
            "geo-title": "Наша Геолокація"
        }
    };
    $((function() {
